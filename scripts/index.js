...
class Board{
    ...
    handleCompleteRows(){
        ...
        const newScore  = ROWS - lastestGrid.length; // => newScore = tong cong hang da hoan thanh
...
function generataNewBrick(){
    brick = new Brick(Math.floor(Math.random()*10) % BRICK_LAYOUT.length) // tao ra 1 id bat ky tu 0 - 6
}
